...
const Navbar = () => {
    return (
        <nav className="border-b border-gray-200">
            <div className="flex justify-between gap-5 container mx-auto py-7">

                <img src={NavbarLogo} alt="Navbar Logo" className="h-10"></img>

                <ul className="flex justify-between items-center gap-5 text-[#475569] font-semibold cursor-pointer">
